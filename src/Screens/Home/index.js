...
import { Dimensions, ScrollView, StyleSheet, TextInput, View, StatusBar, Text, Image, TouchableOpacity,TouchableHighlight} from 'react-native'
  ...
  return (
    <ScrollView style={ styles.container }>
      ...
      <View style={ styles.searchContainer }>
        ...
        <TextInput style={ styles.search } placeholder='Cari Solusi' placeholderTextColor={'grey'}></TextInput>
      </View>
      <View style={ styles.fiturContainer }>
        ...
        <TouchableOpacity  style={[ styles.categoryContainer,{ backgroundColor: Press == 1 ? '#e8fee4' : '#f3f3f3' }]} onPress={()=> setPress(1)}>
          <More size={32} variant='Linear' color='black' />
          <Text style={[ styles.category, { fontWeight: Press == 1 ? '600' : 'normal', color : Press == 1 ? '#005D17' : 'black' }]}>More</Text>
        </TouchableOpacity>
      </View>
      <ScrollView horizontal style={ styles.iklanContainer }>
        ...
        <View style={ styles.iklanContainer2 }>
          ...
          <Image style={styles.iklanImage} source={{ uri: 'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?auto=format&fit=crop&q=80&w=1974&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }} />
